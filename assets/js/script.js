...
$('#add_employee_form, #edit_employee_form').form({
    fields: {
        ...
        gender: {
            ...
            rules: [{
                type: 'empty',
                prompt: 'Please provide a Gender'
            }]
        },
        civilstatus: {
            ...
            rules: [{
                type: 'empty',
                prompt: 'Please provide a Civil Status'
            }]
        },
        birthday: {
            identifier: 'birthday',
            rules: [{
                type: 'empty',
                prompt: 'Please provide a Birthday'
            }]
        },
        emailaddress: {
        ...
        mobileno: {
            ...
            rules: [{
                type: 'empty',
                prompt: 'Please enter a Mobile No.'
            }]
        },
        homeaddress: {
        ...
        jobposition: {
            ...
            rules: [{
                type: 'empty',
                prompt: 'Please select a Job Position'
            }]
        },
        employmenttype: {
            ...
            rules: [{
                type: 'empty',
                prompt: 'Please select a Employment Type'
            }]
        },
        employmentstatus: {
        ...
        startdate: {
            ...
            rules: [{
                type: 'empty',
                prompt: 'Please provide the Official Start Date'
            }]
        },
    }
});
