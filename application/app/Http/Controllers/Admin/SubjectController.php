...
//Model
use App\Subject;
use App\SubjectPrerequisite as SubjPrereq;
...
*/
    ...
    public function index()
    {
        ...
        return view('admin.subject', ["title" => 'Subject', "menu" => "course-curiculum", "sub_menu" => "subject", "formData_subjects" => $subjects]);
    }
...
*/
    ...
    public function getAllSubjects($filter)
    {
        $subject = new Subject;
    ...
    public function ajax_retrieve(Request $request)
    {
        ...
        echo json_encode([
            'status' => "200",
            'data' => $this->getSubject($request->id)
        ]);
    }
