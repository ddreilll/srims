...
class Subject extends Model
{
    ...
    const CREATED_AT = 'subj_dateCreated';
    const UPDATED_AT = 'subj_dateUpdated';
    ...
    public function fetchPrerequisite($md5Id)
    {
        $data = $this->leftJoin('s_subject_prereq', 'subj_subjpreq_id', '=', 'subj_id')
            ...
            ->whereRaw('md5(subj_subjpreq_id) = "' . $md5Id . '" AND subjpreq_isDeleted = "0"')
            ->where(["subj_isDeleted" => "0"])
            ->get();
