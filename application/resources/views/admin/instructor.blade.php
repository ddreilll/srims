                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_add_inst">Add Instructor</button>
                        </div>
            ...
            <div class="modal-content">
                <form class="form" action="#" id="kt_modal_add_inst_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_inst_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_add_inst_header"
                            data-kt-scroll-wrappers="#kt_modal_add_inst_scroll" data-kt-scroll-offset="300px">
                            <!-- Add Modal Form-->
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-bold mb-2">Employee Number</label>
                                <input type="text" class="form-control form-control-solid" placeholder="" name="empNo" />
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <form class="form" action="#" id="kt_modal_edit_inst_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_inst_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_edit_inst_header"
                            data-kt-scroll-wrappers="#kt_modal_edit_inst_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fs-6 fw-bold mb-2">Employee Number</label>
...
@section('scripts')
    <script type="text/javascript">
        KTUtil.onDOMContentLoaded((function() {
            var table = $("#kt_inst_table").DataTable({ // Retrieve all the data
                processing: true,
                ajax: {
            ...
            $('[data-kt-inst-table-filter="search"]').on('keyup', function(e) { // Search bar 
                table.search(e.target.value).draw();
            });

            //--begin::Add Modal--//

            var add_modal = new bootstrap.Modal(document.querySelector('#kt_modal_add_inst'));
            var add_submitBtn = document.getElementById('kt_modal_add_inst_submit');

            var add_form = document.getElementById('kt_modal_add_inst_form');
            var add_formValidation = FormValidation.formValidation(document.getElementById(
                'kt_modal_add_inst_form'), { // Add Form Validation
                fields: {
                    empNo: {
                        validators: {
                            notEmpty: {
            ...
            $('#kt_modal_add_inst_cancel, #kt_modal_add_inst_close').on("click",
            ...
            $("#kt_modal_add_inst_form").on("submit", function(e) { // Add Form Submission
                e.preventDefault(),
                    add_formValidation &&
                    add_formValidation.validate().then(function(e) {
                        ...
                        if ('Valid' == e) {
                            ...
                            $.ajax({
                                ...
                                type: "POST",
                                data: $("#kt_modal_add_inst_form").serialize(),
            ...
            //--begin::Edit Modal--//
            var edit_modal = new bootstrap.Modal(document.querySelector('#kt_modal_edit_inst'));
            var edit_submitBtn = document.getElementById('kt_modal_edit_inst_submit');

            var edit_form = document.getElementById('kt_modal_edit_inst_form');
            ...
            $("#kt_inst_table").on("click", "[kt_inst_table_edit]",
                function() { // Once the Edit button on the DataTable is clicked
                    ...
                    $.ajax({
                        ...
                        if (response['data'].length == 1) {
                            ...
                            $("#kt_modal_edit_inst_form [name='id']").val(data['inst_id_md5']);
                            $("#kt_modal_edit_inst_form [name='empNo']").val(data['inst_empNo']);
                            $("#kt_modal_edit_inst_form [name='name']").val(data['inst_name']);
            ...
            $('#kt_modal_edit_inst_cancel, #kt_modal_edit_inst_close').on("click",
                function( // X and Discard Button
                    t) { // "X" and Discard button
                    t.preventDefault(),
                        Swal.fire({
            ...
            $("#kt_modal_edit_inst_form").on("submit", function(e) { // Edit Form Submission
                e.preventDefault(),
                    edit_formValidation &&
                    edit_formValidation.validate().then(function(e) {
                        ...
                        if ('Valid' == e) {
                            ...
                            $.ajax({
                                ...
                                type: "POST",
                                data: $("#kt_modal_edit_inst_form").serialize(),
            ...
            $("#kt_inst_table").on("click", "[kt_inst_table_delete]",
