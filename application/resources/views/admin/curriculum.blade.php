        ...
        <div class="modal-content">
            <form class="form" action="#" id="kt_modal_add_curriculum_form">
                ...
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_add_curriculum_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_curriculum_header" data-kt-scroll-wrappers="#kt_modal_add_curriculum_scroll" data-kt-scroll-offset="100px">
                        <div id="kt_modal_add_curriculum_list">

                            <a href="#" class="mt-5 btn d-block btn-icon-primary btn-lg p-15 btn-outline btn-outline-dashed btn-outline-primary btn-active-light-primary"><span class="svg-icon svg-icon-1"><span class="svg-icon svg-icon-muted svg-icon-1hx"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
                                            <path opacity="0.3" d="M21 13H3C2.4 13 2 12.6 2 12C2 11.4 2.4 11 3 11H21C21.6 11 22 11.4 22 12C22 12.6 21.6 13 21 13Z" fill="black" />
                                            <path d="M12 22C11.4 22 11 21.6 11 21V3C11 2.4 11.4 2 12 2C12.6 2 13 2.4 13 3V21C13 21.6 12.6 22 12 22Z" fill="black" />
                                        </svg></span></span>Add Year Level</a>
                        </div>
                    </div>
                </div>
