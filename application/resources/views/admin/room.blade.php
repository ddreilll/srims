                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-room-table-filter="search"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search Room" />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#kt_modal_add_room">Add Room</button>
                        </div>
            ...
            <div class="modal-content">
                ...
                <form class="form" action="#" id="kt_modal_add_room_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_room_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_add_room_header"
                            data-kt-scroll-wrappers="#kt_modal_add_room_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <form class="form" action="#" id="kt_modal_edit_room_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_room_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_edit_room_header"
                            data-kt-scroll-wrappers="#kt_modal_edit_room_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
...
@section('scripts')
    <script type="text/javascript">
        ...
        var add_formValidation = FormValidation.formValidation(document.getElementById(
            'kt_modal_add_room_form'), { // Add Form Validation
            fields: {
                name: {
                    validators: {
                        notEmpty: {
        ...
        $("#kt_room_table").on("click", "[kt_room_table_edit]",
        ...
        $("#kt_room_table").on("click", "[kt_room_table_delete]",
