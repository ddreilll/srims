                    ...
                    <div class="card-title">
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-course-table-filter="search"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search Course" />
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <form class="form" action="#" id="kt_modal_add_course_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_course_scroll" data-kt-scroll="true"
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <form class="form" action="#" id="kt_modal_edit_course_form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_course_scroll" data-kt-scroll="true"
                            data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                            data-kt-scroll-dependencies="#kt_modal_edit_course_header"
                            data-kt-scroll-wrappers="#kt_modal_edit_course_scroll" data-kt-scroll-offset="300px">
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="required fs-6 fw-bold mb-2">Code</label>
...
@section('scripts')
    <script type="text/javascript">
        ...
        'kt_modal_add_course_form'), { // Add Form Validation
            fields: {
                'code': {
                    validators: {
                        notEmpty: {
        ...
        $("#kt_course_table").on("click", "[kt_course_table_edit]",
        ...
        $("#kt_course_table").on("click", "[kt_course_table_delete]",
