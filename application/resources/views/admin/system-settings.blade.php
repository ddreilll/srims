...
<div id="kt_drawer_yearLevel_add" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#kt_drawer_yearLevel_add_button" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '500px'}">
...
<div id="kt_drawer_yearLevel_edit" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#kt_drawer_yearLevel_edit_button" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '500px'}">
    <div class="card rounded-0 w-100">
                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-2">
                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column mb-3 mb-md-0 fs-6">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-active-light-dark text-black-50 fw-bolder" data-bs-toggle="tab" href="#settings_curriculum_terms">
                                    <span class="d-flex flex-column align-items-start">
                    ...
                    <div class="tab-pane fade show active" id="settings_curriculum_yearLevel" role="tabpanel">
                        <div class="card pt-4 mb-6 mb-xl-9">
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    <button class="btn btn-sm btn-flex btn-light-primary" id="kt_drawer_yearLevel_add_button">
                            ...
                            <div class="card-body pt-0 pb-5">
                                <div id="settings_curriculum_yearLevel_list" class="rounded p-10 d-flex flex-column draggable-zone">

                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="settings_curriculum_terms" role="tabpanel">
                        <div class="card pt-4 mb-6 mb-xl-9">
                            <div class="card-header border-0">
                                <div class="card-title">
                                    <h2>Terms</h2>
                            ...
                            <div class="card-body pt-0 pb-5">
                                <div id="settings_curriculum_terms_list" class="rounded p-10 d-flex flex-column draggable-zone">
...
<script type="text/javascript">
    KTUtil.onDOMContentLoaded((function() {
        ...
        */
        ...
        var add_drawerElement = document.querySelector("#kt_drawer_yearLevel_add");
        var add_drawer = KTDrawer.getInstance(add_drawerElement);

        var add_submitBtn = document.getElementById('kt_drawer_yearLevel_add_submit');
        var add_form = document.getElementById('kt_drawer_yearLevel_add_form');
        var add_formValidation = FormValidation.formValidation(document.getElementById('kt_drawer_yearLevel_add_form'), { // Add Form Validation
            fields: {
                'name': {
                    validators: {
                        notEmpty: {
        ...
        $('#kt_drawer_yearLevel_add_cancel, #kt_drawer_yearLevel_add_close').on("click", function( // X and Discard Button
        ...
        var edit_drawerElement = document.querySelector("#kt_drawer_yearLevel_edit");
        var edit_drawer = KTDrawer.getInstance(edit_drawerElement);

        var edit_submitBtn = document.getElementById('kt_drawer_yearLevel_edit_submit');
        var edit_form = document.getElementById('kt_drawer_yearLevel_edit_form');
        ...
        $("#settings_curriculum_yearLevel_list").on("click", "[settings_curriculum_yearLevel_edit]", function() {
            ...
            $.ajax({
                ...
                if (response['data'].length == 1) {
                    ...
                    $("#kt_drawer_yearLevel_edit_form [name='id']").val(data['year_id_md5']);
                    $("#kt_drawer_yearLevel_edit_form [name='name']").val(data['year_name']);
        ...
        $('#kt_drawer_yearLevel_edit_cancel, #kt_drawer_yearLevel_edit_close').on("click", function( // X and Discard Button
            t) { // "X" and Discard button
            t.preventDefault(),
                Swal.fire({
                    text: "{{ __('modal.confirmation', ['action' => 'cancel']) }}",
        ...
        //--start::Delete Modal--//
        $("#settings_curriculum_yearLevel_list").on("click", "[settings_curriculum_yearLevel_delete]", function() {
