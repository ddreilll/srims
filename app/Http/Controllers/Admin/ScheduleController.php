...
*/
    ...
    public function getAllSchedules($filter = null)
    {
        ...
        for ($i = 0; $i < sizeOf($schedules); $i++) {
            ...
            $schedules[$i]['sche_inst_fullName'] = format_name(1, $schedules[$i]['sche_inst_name_prefix'],  $schedules[$i]['sche_inst_name_first'], $schedules[$i]['sche_inst_name_middle'], $schedules[$i]['sche_inst_name_last'], $schedules[$i]['sche_inst_name_suffix']);
    ...
    public function getSchedule($md5Id)
    {
        ...
        $schedule[0]['sche_inst_fullName'] = format_name(1, $schedule[0]['sche_inst_name_prefix'],  $schedule[0]['sche_inst_name_first'], $schedule[0]['sche_inst_name_middle'], $schedule[0]['sche_inst_name_last'], $schedule[0]['sche_inst_name_suffix']);
    ...
    public function updateSchedule($md5Id, $sched_details, $time_slots)
    {
        ...
        $timeSlot->permanentRemove(["sche_time_id" => $sched_id]);
    ...
    {
        header('Content-Type: application/json');
        echo json_encode($this->getAllSchedules());
    }
