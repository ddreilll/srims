...
class MessagesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.messages.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('admin.messages.create', compact('users', 'unreads'));
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('admin.messages.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('admin.messages.reply', compact('topic', 'unreads'));
    }
