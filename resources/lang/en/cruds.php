...
return [
    ...
    'document'           => [
        ...
        'fields'         => [
            ...
            'document_category_helper'      => '',
            'document_isPermanent'          => 'Is Permanent',
            'document_isPermanent_helper'   => '',
            'document_createdAt'            => 'Created at',
            'document_createdAt_helper'     => '',
            'document_updatedAt'            => 'Updated at',
            'document_updatedAt_helper'     => '',
            'document_deletedAt'            => 'Deleted at',
            'document_deletedAt_helper'     => '',
        ],
    ],
    'class'           => [
        'title'          => 'Classes',
    ...
    'course'           => [
        ...
        'fields'         => [
            ...
            'course_name'               => 'Name',
            'course_name_helper'        => '',
            'course_createdAt'          => 'Created at',
            'course_createdAt_helper'   => '',
            'course_updatedAt'          => 'Updated at',
            'course_updatedAt_helper'   => '',
            'course_deletedAt'          => 'Deleted at',
            'course_deletedAt_helper'   => '',
        ],
    ],
    'documentType'           => [
