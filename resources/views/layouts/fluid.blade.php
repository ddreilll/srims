                        ...
                        <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                                        ...
                                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                                            ...
                                            <li class="breadcrumb-item">
                                                ...
                                                @if (sizeOf($breadcrumb) != $i + 1)
                                                    ...
                                                    <li class="breadcrumb-item text-muted"><a href="{{ url($breadcrumb[$i]["url"]) }}" class="text-muted text-hover-primary">{{ $breadcrumb[$i]["name"] }}</a></li>
                                                @else
                                                    
                                                     <li class="breadcrumb-item text-dark">{{ $breadcrumb[$i]["name"] }}</li>
                                                @endif
                            ...
                            <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ url('/student/profile/add') }}" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary pulse pulse-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="Add Student Profile">
                                            <i class="fas fa-user-plus fs-4"></i>
                                            <span class="pulse-ring border-3"></span>
                                        </a>

                                        <a href="{{ url('/student/profile/') }}" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="View List of Students">
