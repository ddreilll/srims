...
@section('settings-title')
    {{ __('global.edit') }} {{ __('cruds.document.title_singular') }}
@endsection
...
@section('settings-breadcrumbs')
    {{ Breadcrumbs::render('settings.documents.edit', $document) }}
@endsection
...
@section('settings-content')
    <div class="card mb-6 mb-xl-9">
        ...
        <div class="card-body pt-0 pb-5">
            <form method="POST" action="{{ route('settings.documents.update', $document->docu_id) }}"
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" class="form-control {{ $errors->has('docu_name') ? 'is-invalid' : '' }}"
                        placeholder="" name="docu_name" value="{{ old('docu_name', $document->docu_name) }}" required />
