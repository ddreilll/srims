            ...
            <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <a href="#"
                                    class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-1">{{ $stud_profile->stud_firstName . ' ' . $stud_profile->stud_middleName . ' ' . $stud_profile->stud_lastName }}</a>
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade {!! $stud_profile->stud_recordType == 'SIS' ? 'show active' : '' !!}" id="kt_customer_view_overview_statements" role="tabpanel">
                            <div class="card mb-6">
