                ...
                <div class="d-flex flex-column flex-xl-row ">
                    ...
                    <div class="flex-lg-row-fluid ms-10">
                        <div class="card card-flush py-4 mb-10" id="kt_class_timeslot">
                            ...
                            <div class="card-body py-0">
                                <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true"
                                    ...
                                    data-kt-scroll-wrappers="#kt_class_timeslot_scroll" data-kt-scroll-offset="300px">
                                                ...
                                                <tbody class="align-middle">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="fv-row">
                                                                <input class="form-control form-control-solid"
                                                                    name="gradesheet_file[pages][1][tot_rows]" />
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="fv-row">
                                                                <input class="form-control form-control-solid"
                                                                    name="gradesheet_file[pages][1][file_path]" />
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="fv-row">
                                                                <div class="input-group input-group-solid flex-nowrap">
                                                                    <input class="form-control form-control-solid"
                                                                        name="gradesheet_file[pages][1][file_name]" />
                                                                    <span class="input-group-text">.pdf</span>
                                                                </div>
                                                            </div>
                                                        </td>
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="button" id="kt_class_gradesheet_file_component_saveViewBtn"
                                class="btn btn-primary me-2">
                                <span class="indicator-label">Save and Add Students</span>
                                <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
                            <button type="button" id="kt_class_gradesheet_file_component_saveAddMoreBtn"
                                class="btn btn-primary me-2">
                                <span class="indicator-label">Save and Add more</span>
                                <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
                            <button type="button" id="kt_class_gradesheet_file_component_saveBtn" class="btn btn-success">
    ...
    <script type="text/javascript">
        KTUtil.onDOMContentLoaded((function() {
            ...
            let fv = init_formValidation("kt_class_form_create", {
                ...
                'gradesheet_file[pages][1][tot_rows]': {
                    validators: {
                        notEmpty: {
            ...
            // Saving buttons
            $('#kt_class_gradesheet_file_component_saveViewBtn').on("click", function() {

                const add_submitBtnId = "kt_class_gradesheet_file_component_saveViewBtn";
