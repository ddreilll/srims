                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-end flex-shrink-0">
                                                            <a href="{{ route('settings.year-levels.edit', $yearLevel->year_id) }}"
                                                            ...
                                                            <form
                                                                action="{{ route('settings.year-levels.destroy', $yearLevel->year_id) }}"
                                                                method="POST" id="{{ $yearLevel->year_id }}-destroy">
                                                                @method('DELETE')
                                                                @csrf
                                                                <a href="#"
                                                                    class="btn btn-icon btn-light-danger btn-active-danger btn-sm deleteBtn"
                                                                    data-id="{{ $yearLevel->year_id }}">
                                                                    <span class="svg-icon">
