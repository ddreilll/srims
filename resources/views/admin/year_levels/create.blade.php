                        ...
                        <div class="tab-pane fade show active" role="tabpanel">
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body pt-0 pb-5">
                                    <form method="POST" action="{{ route('settings.year-levels.store') }}"
                                            ...
                                            <div class="col-sm-2">
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        placeholder="" name="year_order" value="{{ old('year_order', '') }}"
                                                        required />
                                            ...
                                            <div class="col-sm-10">
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        placeholder="" name="year_name" value="{{ old('year_name', '') }}"
                                                        required />
