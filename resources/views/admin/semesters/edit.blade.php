...
@section('settings-title')
    {{ __('global.edit') }} {{ __('cruds.semester.title_singular') }} - {{ $semester->term_name }}
@endsection

@section('settings-page-title')
    {{ __('global.edit') }} {{ __('cruds.semester.title_singular') }}
@endsection

@section('settings-breadcrumbs')
    {{ Breadcrumbs::render('settings.semesters.edit', $semester) }}
@endsection
    ...
    <div class="card mb-6 mb-xl-9">
        <div class="card-header border-0">
            <div class="card-title">
                <h2>{{ __('global.edit') }} {{ __('cruds.semester.title_singular') }}</h2>
            </div>
        </div>
        <div class="card-body pt-0 pb-5">
            <form method="POST" action="{{ route('settings.semesters.update', [$semester->term_id]) }}"
                    ...
                    <div class="col-sm-2">
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" class="form-control {{ $errors->has('term_order') ? 'is-invalid' : '' }}"
                                placeholder="" name="term_order" value="{{ old('term_order', $semester->term_order) }}"
                                required />
                    ...
                    <div class="col-sm-10">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control {{ $errors->has('term_name') ? 'is-invalid' : '' }}"
                                placeholder="" name="term_name" value="{{ old('term_name', $semester->term_name) }}"
                                required />
