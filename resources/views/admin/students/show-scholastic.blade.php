...
@section('student-page-title', __('global.view') . ' ' . __('cruds.student.title_singular') . ' - Scholastic Data')
            ...
            @foreach ($schoolYears as $year => $schoolYear)
                <div class="accordion-item">
                    <h2 class="accordion-header" id="scholasticDataHeader{{ $yearCount }}">
                        <button class="accordion-button fs-5 fw-bold {{ $yearCount == 1 ? '' : 'collapsed' }}"
