...
@section('settings-title')
    {{ __('global.edit') }} {{ __('cruds.course.title_singular') }}
@endsection
...
@section('settings-breadcrumbs')
    {{ Breadcrumbs::render('settings.courses.edit', $course) }}
@endsection
    ...
    <div class="card mb-6 mb-xl-9">
        <div class="card-header border-0">
            <div class="card-title">
                <h2>{{ __('global.edit') }} {{ __('cruds.course.title') }}</h2>
            </div>
        </div>
        <div class="card-body pt-0 pb-5">
            <form method="POST" action="{{ route('settings.courses.update', $course->cour_id) }}"
                    ...
                    <div class="col-sm-3">
                        <div class="fv-row">
                            ...
                            <input type="text" class="form-control {{ $errors->has('cour_code') ? 'is-invalid' : '' }}"
                                placeholder="" name="cour_code" value="{{ old('cour_code', $course->cour_code) }}"
                                required />
                    ...
                    <div class="col-sm-9">
                        <div class="fv-row">
                            ...
                            <input type="text" class="form-control {{ $errors->has('cour_name') ? 'is-invalid' : '' }}"
                                placeholder="" name="cour_name" value="{{ old('cour_name', $course->cour_name) }}"
                                required />
