                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                ...
                                <span data-bs-toggle="tooltip" data-bs-custom-class="tooltip-dark" data-bs-trigger="hover"
                                    ...
                                    <a href="#" class="btn btn-sm btn-light-warning" data-bs-toggle="modal"
                            ...
                            <div class="separator separator-dashed my-3"></div>
                            <div id="kt_class_view_pages" class="collapse hide">
                                <div class="py-5 fs-6">

                                    <div class="fw-bolder mt-5">File location</div>
                                    ...
                                    @if ($class->class_file_storage_type == "ONLINE")
                                        <div
                                            ...
                                            <div class="d-flex flex-stack flex-grow-1">
                                                <div class="fw-bold">
                                                    <div class="fs-6 text-gray-700">Access the gradesheet file online<br>
