...
@section('messages-title', trans('global.new_message'))

@section('messages-page-title', trans('global.new_message'))

@section('messages-breadcrumbs')
    {{ Breadcrumbs::render('messages.createTopic') }}
@endsection

@section('messenger-content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('messages.storeTopic') }}" method="POST">
                @csrf
