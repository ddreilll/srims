    ...
    <div id="kt_content_container" class="container-xxl">
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                ...
                <table id="kt_requirement_table" class="table table-row-bordered gy-5 gs-7">
                    <thead>
...
<script type="text/javascript">
    KTUtil.onDOMContentLoaded((function() {
        ...
        function retrieve_form_data(type) {
            return $("#kt_modal_" + type + "_requirement_form").serialize();
        }

        function reset_form(type) {
            $('#kt_modal_' + type + '_requirement_form .form-control-solid').val('');
        }

        var table = $("#kt_requirement_table").DataTable({
            processing: true,
            ajax: {
                    ...
                    for (let i = 0; i < d.length; i++) {
                        ...
                        return_data.push({
                            ...
                            Action: `<div class="d-flex justify-content-start flex-shrink-0">
                                    <a href="javascript:void(0)" kt_table_requirement_edit class="btn btn-icon btn-light-success btn-active-success btn-sm me-1">
                                    ...
                                    <a href="javascript:void(0)" kt_table_requirement_delete class="btn btn-icon btn-light-danger btn-active-danger btn-sm">
        ...
        $('[data-kt-requirement-table-filter="search"]').on('keyup', function(e) {
        ...
        var add_modal = init_modal("kt_modal_add_requirement");
        var add_submitBtnId = "kt_modal_add_requirement_submit";
        var add_formValidation = init_formValidation("kt_modal_add_requirement_form", form_fields);

        $('#kt_modal_add_requirement_cancel, #kt_modal_add_requirement_close').on("click", function(t) {
            t.preventDefault();
        ...
        $("#kt_modal_add_requirement_form").on("submit", function(e) {
        ...
        var edit_modal = init_modal("kt_modal_edit_requirement");
        var edit_submitBtnId = "kt_modal_edit_requirement_submit";
        var edit_formValidation = init_formValidation("kt_modal_edit_requirement_form", form_fields);
        ...
        $('#kt_modal_edit_requirement_cancel, #kt_modal_edit_requirement_close').on("click", function(t) {
        ...
        $("#kt_modal_edit_requirement_form").on("submit", function(e) {
