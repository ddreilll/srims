<x-default-layout>
    ...
    <x-slot:pageTitle>
        @yield('settings-page-title')
    </x-slot:pageTitle>

    <x-slot:breadcrumbs>
        @yield('settings-breadcrumbs')
    </x-slot:breadcrumbs>
        ...
        <div class="d-flex flex-column flex-xl-row">
            ...
            <div class="flex-column flex-lg-row-auto w-100 w-xl-350px mb-10">
                ...
                @if (Gate::check(['document_access']) || Gate::check(['course_access']) || Gate::check(['honor_access']))
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body pb-5">
                            <div class="fw-bold rotate collapsible {{ request()->routeIs('settings.documents.*') || request()->routeIs('settings.courses.*') || request()->routeIs('settings.honors.*') ? '' : 'collapsed' }} h3 mb-4"
                                data-bs-toggle="collapse" href="#students" role="button" aria-expanded="true"
                                ...
                                <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column mb-3 mb-md-0 fs-6">
                                    @can('document_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.documents.*') ? 'active' : '' }}"
                                    ...
                                    @can('course_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.courses.*') ? 'active' : '' }}"
                                    ...
                                    @can('honor_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.honors.*') ? 'active' : '' }}"
                ...
                @if (Gate::check(['room_access']) || Gate::check(['instructor_access']) || Gate::check(['subject_access']))
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body pb-5">
                            <div class="fw-bold rotate collapsible {{ request()->routeIs('settings.rooms.*') || request()->routeIs('settings.instructors.*') || request()->routeIs('settings.subjects.*') ? '' : 'collapsed' }} h3 mb-4"
                            ...
                            <div id="gradesheets"
                                ...
                                <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column mb-3 mb-md-0 fs-6">
                                    @can('room_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.rooms.*') ? 'active' : '' }}"
                                    ...
                                    @can('instructor_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.instructors.*') ? 'active' : '' }}"
                                    ...
                                    @can('subject_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.subjects.*') ? 'active' : '' }}"
                ...
                @if (Gate::check(['year_level_access']) || Gate::check(['semester_access']) || Gate::check(['school_year_access']))
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-body pb-5">
                            ...
                            <div class="fw-bold rotate collapsible {{ request()->routeIs('settings.year-levels.*') || request()->routeIs('settings.semesters.*') || request()->routeIs('settings.school-years.*') ? '' : 'collapsed' }} h3 mb-4"
                                data-bs-toggle="collapse" href="#misc" role="button" aria-expanded="true"
                                aria-controls="misc">Misc
                                <span class="ms-2 rotate-180">
                                    <span class="svg-icon svg-icon-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                            ...
                            <div id="misc"
                                ...
                                <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column mb-3 mb-md-0 fs-6">
                                    @can('year_level_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.year-levels.*') ? 'active' : '' }}"
                                    ...
                                    @can('semester_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.semesters.*') ? 'active' : '' }}"
                                    ...
                                    @can('school_year_access')
                                        <li class="nav-item me-0 mb-md-2">
                                            <a class="nav-link btn btn-active-light-dark text-black-50 fw-bold {{ request()->routeIs('settings.school-years.*') ? 'active' : '' }}"
                    ...
                    <div class="card mb-5 mb-xl-8">
                        <div class="card-header border-0">
                            <div class="card-title">
                                <h3 class="fw-bold  m-0">Backup & Maintenance</h3>
                            </div>
                        </div>
                                ...
                                <div class="d-flex flex-stack flex-grow-1 ">
                                    <div class=" fw-semibold">
                                        ...
                                        <div class="fs-6 text-gray-700 ">
                                            {{ __('panel.setup_maintenance_description') }}
                                        </div>
                                    </div>
