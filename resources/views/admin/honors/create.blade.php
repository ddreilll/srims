...
@section('settings-breadcrumbs')
    {{ Breadcrumbs::render('settings.honors.create') }}
@endsection
...
@section('settings-content')
    <div class="card mb-6 mb-xl-9">
        ...
        <div class="card-body pt-0 pb-5">
            <form method="POST" action="{{ route('settings.honors.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" class="form-control {{ $errors->has('honor_name') ? 'is-invalid' : '' }}"
                        placeholder="" name="honor_name" value="{{ old('honor_name', '') }}" required />
