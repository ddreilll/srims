    ...
    <div id="kt_content_container" class="container-fluid">
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                <table id="kt_room_table" class="table table-row-bordered gy-5 gs-7">
                    <thead>
...
<script type="text/javascript">
    KTUtil.onDOMContentLoaded((function() {
        ...
        function retrieve_form_data(type) {
            return $("#kt_modal_" + type + "_room_form").serialize();
        }
                    ...
                    for (let i = 0; i < d.length; i++) {
                        ...
                        return_data.push({
                            ...
                            Action: `<div class="d-flex justify-content-start flex-shrink-0">
                                <a href="javascript:void(0)" kt_room_table_edit class="btn btn-icon btn-light-success btn-active-success btn-sm me-1">
                                ...
                                <a href="javascript:void(0)" kt_room_table_delete class="btn btn-icon btn-light-danger btn-active-danger btn-sm">
        ...
        var add_modal = init_modal("kt_modal_add_room");
        var add_submitBtnId = "kt_modal_add_room_submit";
        var add_formValidation = init_formValidation("kt_modal_add_room_form", form_fields);

        $('#kt_modal_add_room_cancel, #kt_modal_add_room_close').on("click", function(t) {
            t.preventDefault();
        ...
        $("#kt_modal_add_room_form").on("submit", function(e) {
        ...
        var edit_modal = init_modal("kt_modal_edit_room");
        var edit_submitBtnId = "kt_modal_edit_room_submit";
        var edit_formValidation = init_formValidation("kt_modal_edit_room_form", form_fields);

        $('#kt_modal_edit_room_cancel, #kt_modal_edit_room_close').on("click", function(t) {
        ...
        $("#kt_room_table").on("click", "[kt_room_table_edit]", function() {
            ...
            axios({
                ...
                if (respond.status == 200) {
                    ...
                    if (respond.data.length == 1) {
                        ...
                        $("#kt_modal_edit_room_form [name='id']").val(d['room_id_md5']);
                        $("#kt_modal_edit_room_form [name='name']").val(d['room_name']);
        ...
        $("#kt_modal_edit_room_form").on("submit", function(e) {
        ...
        $("#kt_room_table").on("click", "[kt_room_table_delete]", function() {
