                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div id="notice" class="alert alert-danger d-flex align-items-center p-5 mb-10">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>Duplicate data validation is not enabled, so please double-check any duplicate data
                                    manually.</span>
                            </div>
                        </div>
                ...
                axios({
                    ...
                    if (respond.status == 200) {
                        ...
                        if (respond.data.length == 1) {
                            ...
                            $("#kt_modal_edit_inst_form [name='first_name']").val(d[
                                'inst_firstName']);
                            $("#kt_modal_edit_inst_form [name='middle_name']").val(d[
                                'inst_middleName']);
                            $("#kt_modal_edit_inst_form [name='last_name']").val(d[
                                'inst_lastName']);
                            $("#kt_modal_edit_inst_form [name='suffix_name']").val(d[
                                'inst_suffix']);
