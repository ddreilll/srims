                ...
                <div class="card mb-5 mb-xl-8">
                    ...
                    <div class="card-body pt-2">
                        <ul class="nav nav-tabs nav-pills flex-row border-0 flex-md-column mb-3 mb-md-0 fs-6">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-active-light-dark text-black-50 fw-bolder" data-bs-toggle="tab" href="#settings_curriculum_term">
                                    <span class="d-flex flex-column align-items-start">
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div class="alert bg-light-primary border border-primary d-flex flex-column flex-sm-row p-5 m-8 mb-10 mt-5">
                                    ...
                                    <div class="d-flex flex-column pe-0 pe-sm-10">
                                        ...
                                        <span><span>Drag</span><span class="svg-icon svg-icon-2 me-2 mx-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <div class="tab-pane fade" id="settings_curriculum_term" role="tabpanel">
                        <div class="card pt-4 mb-6 mb-xl-9">
                            <div class="card-header border-0">
                                ...
                                <div class="card-toolbar">
                                    <button type="button" class="btn btn-sm btn-flex btn-light-primary" id="kt_drawer_term_add_button">
                                        <span class="svg-icon svg-icon-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <rect opacity="0.3" x="2" y="2" width="20" height="20" rx="5" fill="black" />
                                                <rect x="10.8891" y="17.8033" width="12" height="2" rx="1" transform="rotate(-90 10.8891 17.8033)" fill="black" />
                            ...
                            <div class="card-body pt-0 pb-5">
                                ...
                                <div id="settings_curriculum_term_list" class="rounded p-10 d-flex flex-column draggable-zone"> </div>
                            </div>
                        </div>
                    </div>
                    <!-- End::Term tabpanel -->
...
<div id="kt_drawer_term_add" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#kt_drawer_term_add_button" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '500px'}">
    <div class="card rounded-0 w-100">
...
<div id="kt_drawer_term_edit" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#kt_drawer_term_edit_button" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'300px', 'md': '500px'}">
    <div class="card rounded-0 w-100">
