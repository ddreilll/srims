...
@section('settings-title')
    {{ __('global.edit') }} {{ __('cruds.yearLevel.title_singular') }} - {{ $yearLevel->year_name }}
@endsection

@section('settings-page-title')
    {{ __('global.edit') }} {{ __('cruds.yearLevel.title_singular') }}
@endsection

@section('settings-breadcrumbs')
    {{ Breadcrumbs::render('settings.year-levels.edit', $yearLevel) }}
@endsection
...
@section('settings-content')
    <div class="card mb-6 mb-xl-9">
        ...
        <div class="card-body pt-0 pb-5">
            <form method="POST" action="{{ route('settings.year-levels.update', [$yearLevel->year_id]) }}"
                    ...
                    <div class="col-sm-2">
                        <div class="fv-row mb-7">
                            ...
                            <input type="number" class="form-control {{ $errors->has('year_order') ? 'is-invalid' : '' }}"
                                placeholder="" name="year_order" value="{{ old('year_order', $yearLevel->year_order) }}"
                                required />
                    ...
                    <div class="col-sm-10">
                        <div class="fv-row mb-7">
                            ...
                            <input type="text" class="form-control {{ $errors->has('year_name') ? 'is-invalid' : '' }}"
                                placeholder="" name="year_name" value="{{ old('year_name', $yearLevel->year_name) }}"
                                required />
