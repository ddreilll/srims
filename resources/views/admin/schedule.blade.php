                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-control="select2"
                                data-placeholder="Select a subject" data-dropdown-parent="#kt_modal_add_schedule_form"
                                name="subject">
                                <option></option>
                        ...
                        <div class="row mb-10">
                            ...
                            <div class="col-md-7 fv-row">
                                ...
                                <select class="form-select form-select-solid" data-control="select2"
                                    ...
                                    data-dropdown-parent="#kt_modal_add_schedule_form" name="year">
                                    <option></option>
                                    @for ($i = 0; $i < sizeOf($formData_acadYears); $i++)
                                        <option value="{{ $formData_acadYears[$i]['syear_year'] }}">
                                            {{ $formData_acadYears[$i]['syear_year'] }} -
                                            {{ $formData_acadYears[$i]['syear_year'] + 1 }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-control="select2"
                                ...
                                @foreach ($formData_instructors as $instructor)
                                    <option value="{{ $instructor->inst_id }}">{{ $instructor->inst_fullName }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="card-body p-2" id="kt_modal_add_schedule_dayTimeSlots">
                            <a href="#" id="kt_modal_add_schedule_dayTimeSlots_addBtn"
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-select form-select-solid" data-control="select2"
                                ...
                                <option></option>
                                @foreach ($formData_instructors as $instructor)
                                    <option value="{{ $instructor->inst_id }}">{{ $instructor->inst_fullName }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
        ...
        KTUtil.onDOMContentLoaded((function() {
            ...
            function add_timeSlot(type, value = []) {
                ...
                if ($("#kt_modal_" + type + "_schedule_dayTimeSlots > div.time-slot").last().length >= 1) {
                    append_element.insertAfter($("#kt_modal_" + type + "_schedule_dayTimeSlots > div.time-slot")
                        .last());
                } else {
                    append_element.prependTo("#kt_modal_" + type + "_schedule_dayTimeSlots");
                }

                $('#kt_modal_' + type + '_schedule_dayTimeSlots > div.time-slot input[name="time"]').last()
                    .daterangepicker({
                        timePicker: true,
                    ...
                    dataSrc: function(d) {
                        ...
                        for (let i = 0; i < d.length; i++) {
                                ...
                                for (let a = 0; a < sched_timeSlots.length; a++) {
                                    ...
                                    if (a == 0) { // start
                                        ...
                                        sched_timeSlot_time += (sched_timeSlots[a][
                                            ...
                                            '') +
                                            "/" : "";
                                    } else if ((a != sched_timeSlots.length - 1) && (a > 0 && a <
                                            sched_timeSlots.length - 1)) { // mid
                            ...
                            return_data.push({
                                ...
                                Instructor: d[i]["sche_inst_fullName"],
            ...
            $("#kt_modal_add_schedule_dayTimeSlots").on("click", "[kt_modal_add_schedule_dayTimeSlots_delete]",
                function() {
                            ...
                            if (respond.status == 200) {
                                ...
                                if (respond.data.isValid) {
                                    ...
                                    axios({
                                        ...
                                        trigger_btnIndicator(edit_submitBtnId,
                                            "default");
