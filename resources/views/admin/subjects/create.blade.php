                            ...
                            <div class="card mb-6 mb-xl-9">
                                <div class="card-header border-0">
                                    <div class="card-title">
                                        <h2>{{ __('global.add') }} {{ __('cruds.subject.title') }}</h2>
                                    </div>
                                </div>
                                    ...
                                    <form method="POST" action="{{ route('settings.subjects.store') }}"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="" name="subj_code" value="{{ old('subj_code', '') }}"
                                                required />
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="" name="subj_name" value="{{ old('subj_name', '') }}"
                                                required />
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="" name="subj_units" value="{{ old('subj_units', '') }}"
                                                required />
