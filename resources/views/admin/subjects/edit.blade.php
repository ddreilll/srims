...
@section('settings-title')
    {{ __('global.edit') }} {{ __('cruds.subject.title_singular') }}
@endsection
...
@section('settings-breadcrumbs')
    {{ Breadcrumbs::render('settings.subjects.edit', $subject) }}
@endsection
            ...
            <form method="POST" action="{{ route('settings.subjects.update', $subject->subj_id) }}"
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" class="form-control {{ $errors->has('subj_code') ? 'is-invalid' : '' }}"
                        placeholder="" name="subj_code" value="{{ old('subj_code', $subject->subj_code) }}" required />
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" class="form-control {{ $errors->has('subj_name') ? 'is-invalid' : '' }}"
                        placeholder="" name="subj_name" value="{{ old('subj_name', $subject->subj_name) }}" required />
                ...
                <div class="fv-row mb-7">
                    ...
                    <input type="text" class="form-control {{ $errors->has('subj_units') ? 'is-invalid' : '' }}"
                        placeholder="" name="subj_units" value="{{ old('subj_units', $subject->subj_units) }}" required />
