                        ...
                        <div class="tab-pane fade show active" role="tabpanel">
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body pt-0 pb-5">
                                    <form method="POST" action="{{ route('settings.instructors.store') }}"
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <input type="text"
                                                ...
                                                placeholder="" name="inst_empNo" value="{{ old('inst_empNo', '') }}"
                                                required />
                                            ...
                                            <div class="col-sm-4">
                                                <div class="fv-row">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('inst_firstName', '') }}" required />
                                            ...
                                            <div class="col-sm-4">
                                                <div class="fv-row">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('inst_lastName', '') }}" required />
