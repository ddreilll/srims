                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="row g-2 mb-5">
                                            <div class="col-sm-6">
                                                <div class="fv-row">
                                                    ...
                                                    @endif
                                                    <span
                                                        class="help-block">{{ trans('cruds.user.fields.name_helper') }}</span>
                                                </div>
                                        ...
                                        <div class="fv-row mb-10">
                                            <div class="required form-label" for="roles">
                                                {{ trans('cruds.user.fields.roles') }}</div>
                                            <select type="text"
                                                class="form-select {{ $errors->has('roles') ? 'is-invalid' : '' }}"
